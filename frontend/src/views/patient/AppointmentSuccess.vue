...
const goToHome = () => router.push('/patient/ai')
</script>

<style lang="scss" scoped>
.success-page { min-height: 100vh; background: #FFF9F0; padding: 32px 16px; }
...
.success-title { text-align: center; font-size: 24px; font-weight: 700; color: #8CB369; }
.success-subtitle { text-align: center; font-size: 14px; color: #8B7A6B; margin-bottom: 24px; }
.info-card { background: #FAF3E8; border-radius: 8px; padding: 12px; margin-bottom: 16px; }
.info-row { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #E8DCC8; &:last-child { border-bottom: none; } }
.info-label { font-size: 14px; color: #8B7A6B; }
.info-value { font-size: 14px; color: #5C4B3A; &.highlight { font-size: 18px; font-weight: 700; color: #F4A261; } }
.tips-card { background: #FFE8D6; border-radius: 8px; padding: 12px; margin-bottom: 24px; }
.tips-title { font-size: 14px; font-weight: 500; color: #E76F51; margin-bottom: 8px; }
.tip-item { font-size: 12px; color: #5C4B3A; padding: 4px 0; }
.action-buttons { display: flex; gap: 12px; }
.action-buttons .van-button { flex: 1; height: 44px; }
.action-buttons .van-button--primary { background: #F4A261; border-color: #F4A261; }
.action-buttons .van-button--plain { color: #F4A261; border-color: #F4A261; }
</style>